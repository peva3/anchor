...
1. **Verify the structure** — all 62 sections must stay linked from the entry-point with a matching skill file. Run the committed structural validator (`./scripts/check_structure.sh`) — it checks index links, duplicate headings, and cross-references.
